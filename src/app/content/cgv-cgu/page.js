...
export default function Cvg() {
  return (
    <main className=" font-[13px]  ">
      <div className="px-20 font-mada mb-28">
        <Breadcrumb slug={" CGV & CGU"} />
        <p className="mt-5 flex flex-row items-start justify-start text-[1.563em] font-medium tracking-wider">
          CGV & CGU
        </p>
      <div className=" pt-5 text-[13px] leading-6 font-[500]  ">
        <p className="font-[500]">CONDITIONS GÉNÉRALES D’UTILISATION ET DE VENTE DU SITE</p>
        <a href="https://bullmanequipment.com/fr/ " className="italic ">https://bullmanequipment.com/fr/ </a>
        <p className="font-[600] mt-6">
...
Le site <a href="https://bullmanequipment.com/fr/ " className="italic text-yellow-500 ">https://bullmanequipment.com/fr/ </a>  est édité par <strong className=" font-semibold"> BULLMAN Equipment</strong>, dont le siège siège social est situé à l’adresse suivante : 47, Boulevard de Courcelles 75008 Paris et immatriculée au 949 013 957.
        </p>
        <p> <strong className=" font-semibold ">Adresse e-mail :</strong> <a href="contact@bullman.fr">contact@bullman.fr</a> </p>
        <p>Le directeur de publication du site est Sébastien Larrère</p>
        <p>Le site <a href="https://bullmanequipment.com/fr/ " className="italic ">https://bullmanequipment.com/fr/ </a>  est hébergé par :</p>
        <p>IONOS dont le siège social se situe au 7, Place de la Gare 57200 Sarreguemines</p>
        <p className="font-[600] mt-6">
        ARTICLE 2. PRÉSENTATION DU SITE
        </p>
        <p>Le site <a href="https://bullmanequipment.com/fr/ " className="italic text-yellow-500 ">https://bullmanequipment.com/fr/ </a>&nbsp;  
        a pour objet la vente en ligne de matériels et équipements sportifs.</p>
        <p className="font-[600] mt-6">
        ARTICLE 3. CONTACT
        </p>
        <p>
        Pour toute question ou demande d’information concernant le site, ou tout signalement de contenu ou d’activités illicites, l’utilisateur peut contacter l’éditeur à l’adresse e-mail suivante: <a href="contact@bullman.fr" className="text-yellow-500 italic">contact@bullman.fr</a>&nbsp; ou adresser un courrier recommandé avec accusé de réception à BULLMAN Equipment, 47 Boulevard de Courcelles 75008 Paris
        </p>
        <p className="font-[600] mt-6">
        ...
        <p>La connexion et la navigation sur le site <a href="https://bullmanequipment.com/fr/ " className="italic text-yellow-500 ">https://bullmanequipment.com/fr/ </a>&nbsp;  valent acceptation sans réserve des présentes Conditions Générales d’Utilisation, quelques soient les moyens techniques d’accès et les terminaux utilisés.</p>
        ...
        <p>L’inscription et l’accès aux services du site sont réservés exclusivement aux personnes physiques capables, ayant rempli et validé le formulaire d’inscription disponible en ligne sur le site <a href="https://bullmanequipment.com/fr/ " className="italic text-yellow-500 ">https://bullmanequipment.com/fr/ </a>&nbsp;  , ainsi que les présentes Conditions Générales d’Utilisation.</p>
        ...
        <p>Toute communication réalisée par <a href="https://bullmanequipment.com/fr/ " className="italic text-yellow-500 ">https://bullmanequipment.com/fr/ </a>&nbsp;  et ses partenaires est en conséquence réputée avoir été réceptionnée et lue par l’utilisateur. Ce dernier s’engage donc à consulter régulièrement les messages reçus sur cette adresse e-mail et à répondre dans un délai raisonnable si cela est nécessaire.</p>
        ...
        <p>https://bullmanequipment.com/fr/  se réserve en tout état de cause la possibilité de refuser une demande d’inscription aux services en cas de non-respect par l’utilisateur des dispositions des présentes Conditions Générales d’Utilisation.</p>
        ...
        <p>Dans le cas où l’éditeur déciderait de supprimer l’espace personnel de l’utilisateur pour l’une de ces raisons, celle-ci ne saurait constituer un dommage pour l’utilisateur dont le compte a été supprimé.

Cette suppression ne saurait constituer une renonciation aux poursuites judiciaires que l’éditeur pourrait entreprendre à l’égard de l’utilisateur étant contrevenu à ces règles.</p>
<p className="font-[600] mt-6">
ARTICLE 8. RESPONSABILITÉS
        ...
        <p>Le site peut contenir des liens hypertextes pointant vers d’autres sites internet sur lesquels </p>
        <p><a href="https://bullmanequipment.com/fr/ " className="italic ">https://bullmanequipment.com/fr/ </a>&nbsp;  n’exerce pas de contrôle. Malgré les vérifications préalables et régulières réalisés par l’éditeur, celui-ci décline tout responsabilité quant aux contenus qu’il est possible de trouver sur ces sites.</p>
        ...
        <p>Sont exclus de cette autorisation les sites diffusant des informations à caractère illicite, violent, polémique, pornographique, xénophobe ou pouvant porter atteinte à la sensibilité du plus grand nombre.

Enfin, <a href="https://bullmanequipment.com/fr/ " className="italic text-yellow-500 ">https://bullmanequipment.com/fr/ </a>&nbsp;   se réserve le droit de faire supprimer à tout moment un lien hypertexte pointant vers son site, si le site l’estime non conforme à sa politique éditoriale.</p>
<p className="font-[600] mt-6">
ARTICLE 10. CONFIDENTIALITE
        ...
        <p>Les données à caractère personnel collectées sur le site <a href="https://bullmanequipment.com/fr/ " className="italic text-yellow-500 ">https://bullmanequipment.com/fr/ </a>&nbsp;  sont les suivantes :</p>
        <p>Nom, prénom, adresse mail, adresse postale, numéro de téléphone, genre, date de naissance.</p>
        <p>Ces données sont collectées lorsque l’utilisateur effectue l’une des opérations suivantes sur le site :</p>
        <p>Lorsque l’utilisateur achète des produits sur le site.</p>
        <p>Par ailleurs, lors de l’achat d’un produit sur le site, il est porté à la connaissance de l’utilisateur que le vendeur conservera dans ses systèmes informatiques une preuve de la transaction comprenant le bon de commande et la facture.</p>
        <p>Le responsable du traitement conservera dans ses systèmes informatiques du site et dans des conditions raisonnables de sécurité l’ensemble des données collectées pour une durée de 15 ans, à moins que l’utilisateur n’en demande la suppression avant l’expiration de cette durée.</p>
        ...
        <p>La collecte et le traitement des données répondent aux finalités suivantes : les données sont enregistrées afin de pouvoir traiter les commandes et les envoyer au client.</p>
        <p className="font-[600] ">
        2. HEBERGEMENT DES DONNEES
        </p>
        <p>Tel que mentionné plus haut, le site  <a href="https://bullmanequipment.com/fr/ " className="italic text-yellow-500 ">https://bullmanequipment.com/fr/ </a>&nbsp;  est hébergé par IONOS dont le siège social se situe au 7, Place de la Gare 57200 Sarreguemines.</p>
        ...
        <p>Le responsable du traitement des données à caractère personnel est Charles Gaston-Dreyfus. Il peut être contacté par mail à l’adresse suivante : <a href="charles@bullman.fr" className="text-yellow-500">charles@bullman.fr</a></p>
        <p className="font-[600] ">
        ...
        <p>L’utilisateur peut prendre connaissance, mettre à jour, modifier ou demander la suppression des données le concernant, en respectant la procédure ci-après énoncée : l’utilisateur doit envoyer un mail à l’adresse <a href="contact@bullman.fr" className="text-yellow-500">contact@bullman.fr</a> avec la mention exacte des informations qu’il souhaite voir supprimer ainsi que son identité.</p>
        <p>S’il en possède un, l’utilisateur a le droit de demander la suppression de son espace personnel en suivant la procédure suivante : l’utilisateur doit envoyer un mail à l’adresse <a href="contact@bullman.fr" className="text-yellow-500">contact@bullman.fr</a>  avec la mention exacte des informations qu’il souhaite voir supprimer ainsi que son identité.</p>
        <p>b. Droit à la portabilité des données</p>
        <p>L’utilisateur a le droit de demander la portabilité de ses données personnelles, détenues par le site, vers un autre site, en se conformant à la procédure ci-après : l’utilisateur doit envoyer un mail à l’adresse contact@bullman.fr avec la mention exacte des informations qu’il souhaite voir supprimer ainsi que son identité.</p>
        ...
        <p>Dans le cas où le responsable du traitement des données décide de ne pas répondre à la demande de l’utilisateur, et que l’utilisateur souhaite contester cette décision, il est en droit de saisir la CNIL (Commission Nationale de l’Informatique et des Libertés, <a href=" https://www.cnil.fr" className="text-yellow-500"> https://www.cnil.fr</a>) ou tout juge compétent.</p>
        <p className="font-[600] ">
        ...
        <p className="font-[600]">1. CONSENTEMENT DE L’UTILISATEUR A L’UTILISATION DE FICHIERS “COOKIES” PAR LE SITE</p>
...
PREAMBULE
        ...
        <p>Le site est édité par le vendeur, BULLMAN Equipment, dont le siège social est situé à l’adresse suivante 47, Boulevard de Courcelles 75008 Paris et immatriculée au 949 013 957.</p>
        <p>Numéro individuel d’identification intracommunautaire du vendeur : FR24 949 013 957.</p>
        <p>Les dispositions suivantes ont pour objet de définir les conditions générales de vente sur le site <a href="https://bullmanequipment.com/fr/ " className="italic text-yellow-500 ">https://bullmanequipment.com/fr/ </a>&nbsp; </p>
        ...
        <p>Le vendeur se réserve le droit de modifier ponctuellement les CGV. Les modifications seront applicables dès leur mise en ligne.
...
ARTICLE 1. CATALOGUE OU BOUTIQUE EN LIGNE
        ...
        <p>Le paiement de la totalité du prix doit être réalisé lors de la commande.
        ...
        <p>En cas de contestation ou d’utilisation frauduleuse de la carte bancaire sans utilisation physique de la carte bancaire (utilisation du numéro de la carte bancaire), toute personne peut contester dans les 70 jours à partir de la date de l’opération en transmettant une réclamation selon les modalités suivantes, afin que le vendeur prenne à sa charge les coûts de la vente et restitue la somme contestée : il devra faire la demande par mail à l’adresse <a href="contact@bullman.fr" className="text-yellow-500">contact@bullman.fr</a> .</p>
        ...
        <p>Pour toute question relative au suivi d’une commande, le client pourra contacter le service client à l’adresse mail suivante : <a href="contact@bullman.fr" className="text-yellow-500">contact@bullman.fr</a> .</p>
        <p className="font-[600] mt-6">
        ...
        <p>Sur des articles en stock, la livraison intervient selon le mode choisi par le client, dans les délais suivants : 24 à 72 heures (jours ouvrés) après validation de la commande par l’utilisateur.</p>
        <p>BULLMAN Equipment (<a href="http://www.bullmanequipment.com/" className="text-yellow-500">www.bullmanequipment.com</a>) ne saurait être tenue responsable de tous retards, manquements de livraisons, ou modifications unilatérales des choix de livraison de l’acheteur par le transporteur (par exemple, sans que cela ne soit exhaustif, dépôt en point relai au lieu d’une dépose domicile). De manière générale, aucune responsabilité ne pourra être imputée à BULLMAN Equipment à partir du moment où le colis est pris en charge par le transporteur.</p>
      </div>
      </div>
    </main>
  );
